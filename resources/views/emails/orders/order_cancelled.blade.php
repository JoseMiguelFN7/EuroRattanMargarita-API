...
<head>
    <meta charset="UTF-8">
    <title>Orden Cancelada - Euro Rattan</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="max-width: 600px; border-radius: 8px; overflow: hidden; border: 1px solid #eaeaec;">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 30px; color: #333333;">
                            <h2 style="font-size: 22px; margin-top: 0; color: #e74c3c;">Tu Orden ha sido Cancelada</h2>
                            
                            <p style="font-size: 16px; line-height: 1.6; color: #555555; margin-bottom: 25px;">
                                Hola <strong>{{ $order->user->name }}</strong>, te escribimos para notificarte que tu orden <strong>#{{ $order->code }}</strong> no podrá ser procesada y ha sido cancelada en nuestro sistema.
                            </p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" bgcolor="#fff3f3" style="border: 2px dashed #ffbaba; border-radius: 8px; margin: 0 auto; width: 100%;">
                                <tr>
                                    <td align="center" style="padding: 20px;">
                                        <p style="font-size: 18px; color: #2c3e50; margin: 0;">Estado de la Orden:</p>
                                        <p style="font-size: 24px; font-weight: bold; color: #e74c3c; margin: 10px 0 0 0;">CANCELADA</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="font-size: 14px; color: #7f8c8d; line-height: 1.5; margin-top: 30px;">
                                Si tienes alguna duda sobre esta cancelación, crees que se trata de un error, o deseas generar un nuevo pedido, por favor no dudes en comunicarte con nuestro equipo de atención al cliente. Estaremos encantados de ayudarte.
                            </p>
                        </td>
                    </tr>
